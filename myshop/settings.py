...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Range requests + static serving
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # <-- ใส่ BASE_DIR / 'templates' ลงไป
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# WhiteNoise — serve static files with Range request support (for video)
WHITENOISE_AUTOREFRESH = True   # pick up file changes without collectstatic in dev
